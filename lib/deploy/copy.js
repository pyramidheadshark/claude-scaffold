...
const HOOKS_DEFINITION = {
  ...
  PostToolUse: [{ matcher: '.*', hooks: [{ type: 'command', command: 'node .claude/hooks/post-tool-use-tracker.js' }, { type: 'command', command: 'node .claude/hooks/session-checkpoint.js' }] }],
